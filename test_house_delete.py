...
source_filename = "tmpekr1xku_.pdf"
...
total_before = len(docs_before.get('ids', [])) if docs_before else 0
...
try:
    ...
    total_after = len(docs_after.get('ids', [])) if docs_after else 0
    print(f"Remaining chunks: {total_after}")
